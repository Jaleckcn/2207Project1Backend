...
//        Complaint complaint = new Complaint(0,"example123@gmail.com","Weird explodey kid keeps breaking the peace and yelling die all the time.", Status.UNREVIEWED,-1);
...
//        Complaint complaint2 = new Complaint(1,"example123@gmail.com","Weird explodey kid keeps breaking the peace and yelling die all the time.",Status.valueOf(Status.IGNORED.toString()),-1);
//        complaintDAO.updateComplaint(1, complaint2);
//        Complaint complaint = complaintDAO.getComplaintById(1);
//        Assertions.assertEquals("example123@gmail.com",complaint.getEmail());
//    }
//
//    @Test
//    @Order(4)
